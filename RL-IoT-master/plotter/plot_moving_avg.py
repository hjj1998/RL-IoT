...
def main():
    ...
    all_graphs_for_specified_path(sarsa_dates, sarsa_lambda_dates, qlearning_dates, qlearning_lambda_dates,
                                  path=target_path)
...
if __name__ == '__main__':
    # main()
    date_array = [
        '2022_05_12_08_31_28_6145585152',
        # '2022_05_12_14_54_16_6145585152',
    ]

    plot_single_algo_multiple_runs(date_array, algorithm='qlearning_lambda', path=2, partial=None)
    # all_graphs_for_specified_path(sarsa, sarsa_lambda, qlearning, qlearning_lambda, path=None)